...
Circle will use a single monorepo with `docs/`, `mobile/`, `web/`, `api/`, and `shared/`. This keeps the Expo app, Next.js Admin panel, Supabase backend assets, shared schemas, and project context in one place while the product is changing quickly.
