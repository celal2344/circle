...
Circle will start with Supabase as the backend boundary. The `api/` folder will hold migrations, Edge Functions/RPC, seed scripts, generated backend assets, and backend notes rather than a custom Node server.
